    ...
    <div className="p-4 rounded-2xl bg-gradient-to-r from-yellow-500/20 to-amber-500/20 border border-yellow-500/20">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-white">Digital Gold</h3>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-3 rounded-xl bg-white/10">
          <p className="text-xs text-gray-400 mb-1">Your Gold</p>
          <p className="text-xl font-bold text-amber-400">{gold.currentBalance}g</p>
          <p className="text-sm text-white">₹{gold.currentValue.toLocaleString()}</p>
        </div>
        <div className="p-3 rounded-xl bg-white/10">
      ...
      {gold.monthlyPlan && (
        <div className="p-3 rounded-xl bg-white/10 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm text-white">Monthly SIP: ₹{gold.monthlyPlan.amount}</p>
              <p className="text-xs text-gray-400">Next: {gold.monthlyPlan.nextDebit}</p>
            </div>
          </div>
