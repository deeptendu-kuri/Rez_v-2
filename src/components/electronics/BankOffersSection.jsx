  ...
  return (
    <div className="px-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="font-semibold text-white">Smart Payments</h2>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-3 rounded-xl bg-[#2C2C2E]">
          ...
          <h4 className="text-sm font-medium text-white">Bank Offers</h4>
          <p className="text-xs text-gray-400">Up to ₹5,000 off</p>
        </div>
        ...
        <div className="p-3 rounded-xl bg-[#2C2C2E]">
          ...
          <h4 className="text-sm font-medium text-white">No Cost EMI</h4>
          <p className="text-xs text-gray-400">0% interest</p>
        </div>
        ...
        <div className="p-3 rounded-xl bg-[#2C2C2E]">
          ...
          <h4 className="text-sm font-medium text-white">Buy Now Pay Later</h4>
          <p className="text-xs text-gray-400">Pay in 30 days</p>
        </div>
        ...
        <div className="p-3 rounded-xl bg-[#2C2C2E]">
          ...
          <h4 className="text-sm font-medium text-white">Pay with Coins</h4>
          <p className="text-xs text-gray-400">Use ReZ Coins</p>
        </div>
      </div>

      {/* Bank Offers */}
      <h3 className="text-sm font-medium text-white mb-3">Active Bank Offers</h3>
      ...
      <div className="mt-4 p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
        <h4 className="text-sm font-medium text-white mb-2">Example EMI</h4>
        <p className="text-xs text-gray-400 mb-3">For ₹30,000 purchase</p>
        <div className="flex items-center justify-between">
          <div className="text-center">
            <p className="text-lg font-bold text-white">₹5,000</p>
            <p className="text-[10px] text-gray-400">6 months @ 0%</p>
          </div>
          <div className="text-center">
