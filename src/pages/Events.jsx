    ...
    <div className="min-h-screen bg-black pb-24">
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-white">Events & Entertainment</h1>
              <p className="text-xs text-gray-400">Movies, live events, experiences — earn rewards</p>
            </div>
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 mt-2 rounded-full bg-white/10">
            ...
            <span className="text-sm text-white">Bangalore</span>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between px-4 mb-3">
          <h2 className="font-semibold text-white">Explore Categories</h2>
        </div>
        <EventCategoryGrid
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Now Showing</h2>
          </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Live Events & Concerts</h2>
          </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Festivals & Flea Events</h2>
          </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Workshops & Classes</h2>
          </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Amusement & Parks</h2>
          </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Gaming, VR & Play</h2>
          </div>
      ...
      <div className="mt-8">
        ...
        <p className="text-sm text-gray-400 px-4 mb-3">Handpicked for you by ReZ AI</p>
        <div className="flex gap-4 px-4 overflow-x-auto hide-scrollbar pb-2">
      ...
      <div className="mx-4 mt-8 p-4 rounded-2xl bg-[#2C2C2E]">
        <h3 className="font-semibold text-white mb-3">How Rewards Work</h3>
        <ol className="space-y-3">
          <li className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
              <span className="text-xs font-bold text-emerald-400">1</span>
            </span>
            <span className="text-sm text-gray-300">Discover movies, events & experiences</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
              <span className="text-xs font-bold text-emerald-400">2</span>
            </span>
            <span className="text-sm text-gray-300">Book & pay with ReZ Wallet</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
              <span className="text-xs font-bold text-emerald-400">3</span>
            </span>
            <span className="text-sm text-gray-300">Attend & earn cashback + bonus coins</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
              <span className="text-xs font-bold text-emerald-400">4</span>
            </span>
            <span className="text-sm text-gray-300">Share moments, earn even more!</span>
          </li>
        </ol>
      </div>
