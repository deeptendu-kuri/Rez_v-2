...
const FoodCategoryGrid = ({ onCategorySelect }) => {
  return (
    <div className="px-4 mt-4">
      <h2 className="font-semibold text-rez-navy dark:text-white mb-3">What are you craving?</h2>
      <div className="grid grid-cols-4 gap-3">
        {foodCategories.map((category) => (
          ...
          >
            ...
            <span className="text-[10px] text-rez-gray-600 dark:text-gray-500">{category.count}+ places</span>
          </button>
        ))}
      </div>
    </div>
