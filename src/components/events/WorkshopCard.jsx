  ...
  if (variant === 'featured') {
    return (
      <Link
        ...
        className="block min-w-[280px] rounded-2xl overflow-hidden bg-[#1C1C1E] shrink-0"
      >
        {/* Image */}
        ...
        <div className="p-4">
          ...
          <p className="text-sm text-gray-400 mt-0.5">by {workshop.instructor}</p>
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/5">
            <div>
              <p className="text-lg font-semibold text-white">₹{workshop.price.toLocaleString()}</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <h4 className="font-medium text-white truncate mt-1">{workshop.title}</h4>
        <p className="text-xs text-gray-400">{workshop.date} • {workshop.duration}</p>

        <div className="flex items-center gap-2 mt-1">
          <span className="text-sm font-medium text-white">₹{workshop.price}</span>
