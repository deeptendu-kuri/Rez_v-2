      ...
      >
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-medium text-white truncate">{gym.name}</h3>
            <div className="flex items-center gap-1">
              <Star className="w-3 h-3 text-amber-400 fill-amber-400" />
              <span className="text-xs text-white">{gym.rating}</span>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-sm text-white">{gym.rating}</span>
      ...
      <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/10">
        <div>
          <p className="text-lg font-bold text-white">₹{gym.monthlyPrice}<span className="text-xs text-gray-400 font-normal">/month</span></p>
          <p className="text-xs text-gray-400">₹{gym.pricePerSession}/session</p>
        </div>
