  ...
  return (
    <div className="min-h-screen bg-black pb-24">
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-white">Organic Store</h1>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E]">
        <h3 className="font-semibold text-white mb-3">Why Choose Organic on ReZ?</h3>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">✅</span>
            <h4 className="text-sm font-medium text-white mt-1">Certified Pure</h4>
            <p className="text-xs text-gray-400 mt-0.5">100% verified products</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">🪙</span>
            <h4 className="text-sm font-medium text-white mt-1">Earn More</h4>
            <p className="text-xs text-gray-400 mt-0.5">Up to 15% cashback</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">📦</span>
            <h4 className="text-sm font-medium text-white mt-1">Subscribe</h4>
            <p className="text-xs text-gray-400 mt-0.5">Auto-delivery savings</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">🌍</span>
            <h4 className="text-sm font-medium text-white mt-1">Eco Rewards</h4>
            <p className="text-xs text-gray-400 mt-0.5">Bonus for green choices</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between px-4 mb-3">
          <h2 className="font-semibold text-white">Popular Organic Products</h2>
          <button className="text-xs flex items-center gap-1" style={{ color: theme.primary }}>
            View All <ChevronRight className="w-3 h-3" />
          </button>
        </div>
            ...
            >
              ...
              <div className="flex gap-1 mt-1">
                {product.certifications.map((cert, idx) => (
                  <span key={idx} className="text-[10px] px-1.5 py-0.5 rounded bg-white/10 text-gray-400">{cert}</span>
                ))}
              </div>
      ...
      <div className="mt-6 px-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-semibold text-white">Earn Eco Bonus Coins</h2>
        </div>
          ...
          {organicStore.ecoActions.map((action) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-gray-400">Small step, big impact</p>
              </div>
      ...
      {/* Education Section */}
      <div className="mt-6 px-4">
        <h2 className="font-semibold text-white mb-3">Learn About Organic</h2>
        <div className="space-y-3">
          {organicStore.education.map((edu) => (
            <div key={edu.id} className="p-4 rounded-2xl bg-[#2C2C2E]">
              <h3 className="font-medium text-white">{edu.title}</h3>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Organic Stores Nearby</h2>
          </div>
        </div>
          ...
          {['Nature\'s Basket', 'Organic World', 'Green Mart'].map((store, idx) => (
            <div key={idx} className="p-4 rounded-2xl bg-[#2C2C2E] flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">{1.2 + idx * 0.5} km away • Open now</p>
              </div>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl border" style={{ backgroundColor: `${theme.primary}10`, borderColor: `${theme.primary}30` }}>
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="font-semibold text-white">Green Shopper Badge</h3>
            <p className="text-xs text-gray-400">3 more organic purchases to unlock</p>
          </div>
        </div>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E] text-center">
        <h3 className="font-semibold text-white mb-2">Pure. Natural. Rewarding.</h3>
        <p className="text-sm text-gray-400">Better for you. Better for the planet. With ReZ rewards.</p>
      </div>
      ...
      <div className="fixed bottom-20 left-0 right-0 px-4 z-50">
        <div className="p-3 rounded-2xl shadow-xl flex items-center justify-between" style={{ backgroundColor: theme.primary }}>
          <div>
            <p className="text-sm font-medium text-white">🌿 Save ₹450 on Organic today</p>
            <p className="text-xs text-white/70">Subscribe for extra savings</p>
          </div>
          <div className="flex gap-2">
            <Button variant="secondary" size="sm" className="bg-white/20 text-white border-0">Subscribe</Button>
