    ...
    <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/20">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-rez-navy dark:text-white">Your Health Savings</h3>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 rounded-xl bg-rez-gray-100 dark:bg-white/10">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-rez-gray-600 dark:text-gray-400">This Year</span>
          </div>
          <p className="text-xl font-bold text-rez-navy dark:text-white">₹{savings.thisYear.toLocaleString()}</p>
        ...
        <div className="p-3 rounded-xl bg-rez-gray-100 dark:bg-white/10">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-rez-gray-600 dark:text-gray-400">Coins Earned</span>
          </div>
          <p className="text-xl font-bold text-amber-400">{savings.totalCoins.toLocaleString()}</p>
          <p className="text-xs text-rez-gray-600 dark:text-gray-400">from {savings.visits} visits</p>
        </div>
      </div>
      ...
      <div className="mt-3 p-3 rounded-xl bg-rez-gray-100 dark:bg-white/10">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-lg font-bold text-rez-navy dark:text-white">₹{savings.thisMonth}</p>
          </div>
