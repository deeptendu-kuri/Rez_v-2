    ...
    <section className="py-4">
      <div className="px-4 mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">Nearby Hotspots</h2>
            <p className="text-sm text-gray-400">Top deals by area</p>
          </div>
        </div>
      </div>
        ...
        {hotspotDeals.map((hotspot, index) => (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold text-white">{hotspot.area}</span>
            </div>

            <p className="text-sm text-gray-300">{hotspot.topDeal}</p>

            <div className="flex items-center justify-between mt-3">
              <span className="text-xs text-gray-400">{hotspot.count} deals</span>
