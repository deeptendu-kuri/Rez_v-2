...
const FitnessProductCard = ({ product }) => {
  return (
    <Link
      ...
      className="min-w-[160px] p-3 rounded-2xl bg-[#2C2C2E] shrink-0 active:scale-[0.98] transition-transform"
    >
      <div className="relative mb-3">
        ...
        {product.discount > 0 && (
          <span className="absolute top-2 left-2 px-1.5 py-0.5 rounded bg-red-500 text-[10px] text-white font-bold">
            -{product.discount}%
          </span>
        )}
      </div>
