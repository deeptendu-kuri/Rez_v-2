  ...
  return (
    <div className="p-4 rounded-2xl bg-[#2C2C2E]">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-semibold text-white">OTT Subscriptions</h3>
      ...
      <div className="flex gap-3 overflow-x-auto hide-scrollbar pb-2">
        {ottList.map((ott) => (
          <Link
            ...
            className="min-w-[120px] p-3 rounded-xl bg-white/5 shrink-0 text-center active:scale-[0.98] transition-transform"
          >
            <span className="text-3xl mb-2 block">{ott.icon}</span>
            <p className="text-sm font-medium text-white">{ott.name}</p>
            <p className="text-xs text-gray-400">₹{ott.price}/mo</p>
