    ...
    <div className="px-4 py-4">
      <div className="p-4 rounded-2xl bg-rez-gray-100 dark:bg-[#1C1C1E]">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-medium text-rez-navy dark:text-white">People near you are earning</h3>
        ...
        <div className="space-y-2">
          {getVisibleActivities().map((activity, index) => (
            <div
              ...
              className={`flex items-center gap-3 p-2 rounded-xl bg-rez-gray-50 dark:bg-white/5 transition-all duration-500 ${
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm text-rez-navy dark:text-white">
                  ...
                  <span className="text-rez-gray-600 dark:text-gray-400"> at </span>
                  <span className="text-rez-navy dark:text-white">{activity.store}</span>
                </p>
              </div>
              <span className="text-[10px] text-rez-gray-600 dark:text-gray-500">{activity.time}</span>
            </div>
          ))}
        </div>

        {/* Stats */}
        <div className="flex items-center justify-center gap-4 mt-4 pt-3 border-t border-rez-gray-200 dark:border-white/10">
          <div className="text-center">
            <p className="text-lg font-bold text-emerald-400">₹24,500</p>
            <p className="text-[10px] text-rez-gray-600 dark:text-gray-400">Saved today nearby</p>
          </div>
          <div className="w-px h-8 bg-rez-gray-100 dark:bg-white/10" />
          <div className="text-center">
            <p className="text-lg font-bold text-amber-400">1,240</p>
            <p className="text-[10px] text-rez-gray-600 dark:text-gray-400">Active users</p>
          </div>
        </div>
      </div>
    </div>
