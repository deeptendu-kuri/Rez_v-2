  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black pb-32">
      ...
      <div className="px-4 py-4">
        <div className="mb-4">
          <div className="relative rounded-3xl overflow-hidden bg-rez-gray-50 dark:bg-white/5 aspect-video">
            <img
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
              <div className="px-4 py-2 rounded-full bg-white dark:bg-black/60 backdrop-blur-lg border border-white/20 flex items-center gap-2">
                <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
                <span className="text-sm font-bold text-rez-navy dark:text-white">{service.rating}</span>
                <span className="text-xs text-rez-gray-700 dark:text-gray-300">({service.reviews} reviews)</span>
              </div>
            </div>
          </div>
        ...
        {/* Service Identity */}
        <div className="mb-4">
          <p className="text-sm text-rez-gray-600 dark:text-gray-400 mb-1">{service.category} · {service.provider}</p>
          <h1 className="text-2xl font-bold text-rez-navy dark:text-white mb-2">{service.name}</h1>

          <div className="flex items-center gap-4 mb-3">
            <div className="flex items-center gap-1">
              <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
              <span className="text-sm font-semibold text-rez-navy dark:text-white">{service.rating}</span>
              <span className="text-sm text-rez-gray-600 dark:text-gray-400">({service.reviews} reviews)</span>
            </div>
            {service.verified && (
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-3xl bg-gradient-to-br from-emerald-500/20 via-emerald-600/10 to-amber-500/10 border border-emerald-500/30">
          <p className="text-sm text-rez-gray-700 dark:text-gray-300 mb-3">Service Price</p>

          <div className="space-y-2 mb-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-rez-gray-600 dark:text-gray-400 line-through">Regular Price</span>
              <span className="text-sm text-rez-gray-600 dark:text-gray-400 line-through">₹{service.mrp.toLocaleString()}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-base text-rez-navy dark:text-white font-semibold">ReZ Price</span>
              <span className="text-2xl text-rez-navy dark:text-white font-bold">₹{service.rezPrice.toLocaleString()}</span>
            </div>
          ...
          <div className="pt-4 border-t border-rez-gray-200 dark:border-white/10">
            <p className="text-sm text-rez-gray-700 dark:text-gray-300 mb-3">Rewards</p>
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                <span className="text-rez-gray-700 dark:text-gray-300">🪙 Earn ReZ Coins</span>
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-rez-gray-700 dark:text-gray-300">🎁 Share Bonus</span>
      ...
      <div className="px-4 mb-6">
        <div className="flex gap-3">
          <div className="flex-1 p-4 rounded-2xl bg-gradient-to-br from-orange-500/20 to-red-600/10 border border-orange-500/30">
            ...
            <p className="text-sm text-rez-navy dark:text-white font-bold">{service.urgency.message}</p>
          </div>
          <div className="flex-1 p-4 rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-600/10 border border-blue-500/30">
            ...
            <p className="text-sm text-rez-navy dark:text-white font-bold">{viewersCount} people viewing</p>
          </div>
        </div>
      </div>
      ...
      {/* 🎁 REZ BENEFITS STRIP */}
      <div className="px-4 mb-6">
        <h3 className="text-sm font-bold text-rez-gray-600 dark:text-gray-400 mb-3 uppercase tracking-wide">Why Book with ReZ</h3>
        ...
        <div className="px-4 mb-6">
          <div className="p-4 rounded-2xl bg-gradient-to-r from-purple-500/20 to-pink-600/10 border border-purple-500/30">
            <div className="flex items-center justify-between mb-3">
              <p className="text-sm font-semibold text-rez-navy dark:text-white">Glowzy Loyalty Progress</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-bold text-rez-navy dark:text-white">Offers & Deals</p>
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <p className="text-sm font-bold text-rez-navy dark:text-white">{offer.title}</p>
                      <Badge
      ...
      {/* 📅 DATE SELECTION */}
      <div className="px-4 mb-6">
        <h3 className="text-lg font-bold text-rez-navy dark:text-white mb-3">Select Date</h3>
        <div className="flex gap-2 overflow-x-auto hide-scrollbar">
          {service.availableDates.map((dateObj) => (
            ...
            >
              <p className="text-xs text-rez-gray-600 dark:text-gray-400 mb-1">{dateObj.day}</p>
              <p className="text-lg font-bold text-rez-navy dark:text-white">{new Date(dateObj.date).getDate()}</p>
      ...
      {selectedDate && (
        <div className="px-4 mb-6">
          <h3 className="text-lg font-bold text-rez-navy dark:text-white mb-3">Available Time Slots</h3>

          <div className="space-y-4">
            {/* Morning Slots */}
            <div>
              <p className="text-sm font-semibold text-rez-gray-600 dark:text-gray-400 mb-2">Morning</p>
                  ...
                  <button
                    ...
                    className={`p-3 rounded-xl text-sm font-medium transition-all ${
                      selectedSlot === slot.time
                        ...
                        : 'bg-white/5 text-rez-gray-700 dark:text-gray-600 border border-white/10 opacity-50 line-through'
                    }`}
                  >
                    {slot.time}
                    {slot.available && (
                      <span className="block text-[10px] text-rez-gray-600 dark:text-gray-400 mt-0.5">Available</span>
                    )}
                  </button>
                ))}
              </div>
            ...
            {/* Afternoon Slots */}
            <div>
              <p className="text-sm font-semibold text-rez-gray-600 dark:text-gray-400 mb-2">Afternoon</p>
              <div className="grid grid-cols-3 gap-2">
            ...
            {/* Evening Slots */}
            <div>
              <p className="text-sm font-semibold text-rez-gray-600 dark:text-gray-400 mb-2">Evening</p>
              <div className="grid grid-cols-3 gap-2">
      ...
      {selectedSlot && (
        <div className="px-4 mb-6">
          <h3 className="text-lg font-bold text-rez-navy dark:text-white mb-3">Choose Professional</h3>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 text-left">
                    <div className="flex items-center gap-2 mb-1">
                      <p className="text-sm font-semibold text-rez-navy dark:text-white">{pro.name}</p>
                      {pro.rating >= 4.9 && (
                    ...
                    <p className="text-xs text-rez-gray-600 dark:text-gray-400 mb-2">{pro.specialization}</p>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs text-rez-gray-600 dark:text-gray-400">{pro.experience}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Users className="w-3 h-3 text-blue-400" />
                        <span className="text-xs text-rez-gray-600 dark:text-gray-400">{pro.completed} services</span>
                      </div>
                    </div>
      ...
      <div className="px-4 mb-6">
        <div className="p-4 rounded-2xl bg-gradient-to-r from-amber-500/20 to-orange-600/10 border border-amber-500/30">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-rez-navy dark:text-white mb-1">Why Book Now</p>
              <p className="text-sm text-rez-gray-700 dark:text-gray-300">{service.aiSuggestion}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-2xl bg-rez-gray-50 dark:bg-white/5 border border-rez-gray-200 dark:border-white/10">
          <h3 className="text-base font-bold text-rez-navy dark:text-white mb-4 flex items-center gap-2">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 rounded-xl bg-emerald-500/20 border-2 border-emerald-500/50">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-rez-navy dark:text-white">{service.provider} (ReZ)</span>
            ...
            {service.comparePrices.map((comp, idx) => (
              <div key={idx} className="p-3 rounded-xl bg-rez-gray-50 dark:bg-white/5 border border-rez-gray-200 dark:border-white/10">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-rez-gray-700 dark:text-gray-300">{comp.store}</span>
                  <div className="text-right">
                    <span className="text-sm font-semibold text-rez-gray-700 dark:text-gray-300">₹{comp.price.toLocaleString()}</span>
                    {comp.cashback > 0 && (
                      <p className="text-xs text-rez-gray-600 dark:text-gray-500">+ ₹{comp.cashback} cashback</p>
                    )}
                  </div>
                </div>
              </div>
      ...
      {/* 🔄 SIMILAR SERVICES */}
      <div className="px-4 mb-6">
        <h3 className="text-lg font-bold text-rez-navy dark:text-white mb-3">Similar Services at {service.provider}</h3>
        <div className="flex gap-3 overflow-x-auto hide-scrollbar">
          {service.similarServices.map((similar) => (
            <div
              key={similar.id}
              onClick={() => navigate(`/booking/${similar.id}`)}
              className="flex-shrink-0 w-56 p-3 rounded-2xl bg-rez-gray-50 dark:bg-white/5 border border-rez-gray-200 dark:border-white/10 active:scale-95 transition-transform cursor-pointer"
            >
              <div className="relative rounded-xl overflow-hidden mb-3 aspect-video">
                ...
                <div className="absolute top-2 right-2">
                  <div className="px-2 py-1 rounded-full bg-white dark:bg-black/60 backdrop-blur-sm flex items-center gap-1">
                    <Star className="w-3 h-3 text-amber-400 fill-amber-400" />
                    <span className="text-xs font-semibold text-rez-navy dark:text-white">{similar.rating}</span>
                  </div>
                </div>
              </div>
              <h4 className="text-sm font-semibold text-rez-navy dark:text-white mb-1 line-clamp-1">{similar.name}</h4>
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs text-rez-gray-600 dark:text-gray-400">{similar.duration}</span>
      ...
      {selectedProfessional && (
        <div className="px-4 mb-6">
          <h3 className="text-lg font-bold text-rez-navy dark:text-white mb-3">Pay with ReZ</h3>
          <div className="p-5 rounded-3xl bg-gradient-to-br from-purple-500/20 to-blue-600/10 border border-purple-500/30">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-rez-navy dark:text-white mb-1">Automatic Coin Application</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-rez-navy dark:text-white mb-1">Smart Priority Order</p>
                  <p className="text-xs text-rez-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-rez-navy dark:text-white mb-1">Flexible Payment</p>
                  <p className="text-xs text-rez-gray-700 dark:text-gray-300">
            ...
            <div className="mt-4 p-3 rounded-xl bg-rez-gray-50 dark:bg-white/5 border border-rez-gray-200 dark:border-white/10">
      ...
      <div className="px-4 mb-6">
        ...
        <div className="p-5 rounded-2xl bg-rez-gray-50 dark:bg-white/5 border border-rez-gray-200 dark:border-white/10">
            ...
            <div className="space-y-3">
              {service.included.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-rez-gray-700 dark:text-gray-300">{item}</p>
                </div>
              ))}
            </div>
          )}
          ...
          {activeTab === 'description' && (
            <p className="text-sm text-rez-gray-700 dark:text-gray-300 leading-relaxed">{service.description}</p>
          )}
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="text-center">
                  <p className="text-4xl font-bold text-rez-navy dark:text-white mb-1">{service.rating}</p>
                  ...
                  <p className="text-xs text-rez-gray-600 dark:text-gray-400">{service.reviews} reviews</p>
                </div>
                  ...
                  <div className="space-y-1">
                    {[5, 4, 3, 2, 1].map((stars) => (
                      <div key={stars} className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-rez-gray-600 dark:text-gray-400 w-10">
              ...
              {/* Review Highlights */}
              <div className="mb-6">
                <p className="text-sm font-semibold text-rez-navy dark:text-white mb-3">What people love</p>
              ...
              {/* UGC Preview */}
              <div>
                <p className="text-sm font-semibold text-rez-navy dark:text-white mb-3">Recent Reviews</p>
                <div className="space-y-3">
                  {[1, 2, 3].map((review) => (
                    <div key={review} className="p-3 rounded-xl bg-rez-gray-50 dark:bg-white/5">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <p className="text-sm font-medium text-rez-navy dark:text-white">User {review}</p>
                          ...
                          <p className="text-xs text-rez-gray-600 dark:text-gray-400">Verified booking · 2 weeks ago</p>
                        </div>
                      </div>
                      <p className="text-xs text-rez-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          {activeTab === 'location' && (
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-rez-navy dark:text-white">{service.location}</p>
                  <p className="text-xs text-rez-gray-600 dark:text-gray-400 mt-1">{service.distance} away</p>
                </div>
              </div>
      ...
      <div className="px-4 mb-6">
        <div className="p-5 rounded-2xl bg-rez-gray-50 dark:bg-white/5 border border-rez-gray-200 dark:border-white/10">
          <h3 className="text-sm font-bold text-rez-navy dark:text-white mb-4 text-center">Trust & Safety</h3>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <p className="text-[10px] text-rez-gray-600 dark:text-gray-400">100% safe transactions</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-xs font-semibold text-rez-navy dark:text-white mb-1">Verified Salon</p>
              <p className="text-[10px] text-rez-gray-600 dark:text-gray-400">Quality guaranteed</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-[10px] text-rez-gray-600 dark:text-gray-400">Always here to help</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 glass border-t border-rez-gray-200 dark:border-white/10 p-4">
        <div className="flex items-center gap-3">
          <div className="flex-1">
            <p className="text-xs text-rez-gray-600 dark:text-gray-400">Total Amount</p>
            <p className="text-xl font-bold text-rez-navy dark:text-white">₹{service.rezPrice.toLocaleString()}</p>
          ...
          <button
            ...
            className={`px-8 py-4 rounded-2xl font-bold flex items-center gap-2 transition-all ${
              selectedDate && selectedSlot && selectedProfessional
                ...
                : 'bg-gray-600 text-rez-gray-600 dark:text-gray-400 cursor-not-allowed'
            }`}
          >
      ...
      <div className="px-4 pb-6">
        <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-500/20 to-blue-600/10 border border-purple-500/30 text-center">
          ...
          <p className="text-xs text-rez-gray-700 dark:text-gray-300">That's ReZ Beauty.</p>
        </div>
      </div>
    </div>
  );
