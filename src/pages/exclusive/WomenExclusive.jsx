    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-900/20 to-black pb-24">
      ...
      <div className="sticky top-0 z-40 glass">
        <div className="flex items-center gap-4 px-4 py-4">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-white">Women Exclusive</h1>
            <p className="text-sm text-gray-400">Beauty, wellness & lifestyle</p>
          </div>
      ...
      <div className="mx-4 mt-4 p-6 rounded-3xl bg-gradient-to-r from-pink-500/30 via-rose-500/20 to-purple-500/30 border border-pink-500/20 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h2 className="text-2xl font-bold text-white">Celebrate You</h2>
          <p className="text-gray-300 mt-1">Exclusive deals on beauty, fashion & wellness</p>
      ...
      <div className="mt-6">
        ...
        <div className="flex gap-3 px-4 overflow-x-auto hide-scrollbar pb-2">
          {categories.map((cat) => (
            <button
              key={cat.id}
              className="flex flex-col items-center p-4 rounded-2xl bg-[#2C2C2E] shrink-0 min-w-[100px] active:bg-[#3A3A3C]"
            >
      ...
      <div className="mt-6">
        <div className="px-4 mb-3">
          <h3 className="text-lg font-semibold text-white">Featured Brands</h3>
        </div>
        <div className="flex gap-4 px-4 overflow-x-auto hide-scrollbar pb-2">
          {['Nykaa', 'Myntra', 'VLCC', 'Fab India'].map((brand, i) => (
            ...
            >
              <span className="text-xs text-gray-300 text-center">{brand}</span>
            </div>
          ))}
        </div>
      </div>
          ...
          <Card key={deal.id} className="overflow-hidden" hover>
            <div className="flex">
              ...
              <div className="flex-1 p-4">
                ...
                <p className="text-sm text-gray-400 mt-1 line-clamp-2">{deal.description}</p>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-gradient-to-r from-rose-500/10 to-pink-500/10 border border-rose-500/20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="font-semibold text-white">Self-Care Sunday</p>
            <p className="text-sm text-gray-300">Extra 10% off on wellness services</p>
          </div>
        </div>
      </div>
