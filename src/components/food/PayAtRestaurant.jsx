    ...
    return (
      <div className="p-4">
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 mb-4">
          ...
          />
          <div>
            <p className="font-medium text-white">{selectedRestaurant.name}</p>
            <p className="text-xs text-gray-400">{selectedRestaurant.distance}</p>
          </div>
        </div>

        {/* Bill breakdown */}
        <div className="p-4 rounded-xl bg-[#1C1C1E] space-y-3 mb-4">
          <div className="flex items-center justify-between">
            <span className="text-gray-400">Bill Amount</span>
            <span className="text-white">₹{bill.toFixed(0)}</span>
          </div>
        ...
        <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 mb-4">
          <p className="text-xs text-gray-400 mb-2">You'll earn</p>
  ...
  if (step === 'amount') {
    return (
      <div className="p-4">
        ...
        {/* Amount input */}
        <div className="mb-6">
          <label className="block text-sm text-gray-400 mb-2">Enter Bill Amount</label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="0"
              className="w-full pl-12 pr-4 py-4 rounded-xl bg-white/10 text-2xl font-bold text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2 mb-6">
          {[500, 1000, 1500, 2000].map((amount) => (
            <button
              ...
              className="py-2 rounded-lg bg-white/5 text-sm text-gray-400 hover:bg-white/10 transition-colors"
            >
              ₹{amount}
            </button>
          ))}
        ...
        <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-white">ReZ Coins Available</span>
            </div>
            <span className="text-sm font-medium text-amber-400">{rezCoins}</span>
          </div>
          <p className="text-xs text-gray-400 mt-1">Use up to 20% of bill with coins</p>
        </div>
  ...
  return (
    <div className="p-4">
      ...
      <div className="text-center mb-6">
        ...
        <h3 className="text-lg font-semibold text-white">Pay at Restaurant</h3>
        <p className="text-sm text-gray-400">Scan QR or select restaurant</p>
      </div>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/10 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
        />
      </div>
