  ...
  return (
    ...
    >
      ...
      <div className="relative h-40">
        ...
        {/* Rating */}
        <div className="absolute bottom-3 right-3 flex items-center gap-1 px-2 py-0.5 rounded-full bg-black/60 backdrop-blur-sm">
          <Star className="w-3 h-3 text-amber-400 fill-amber-400" />
          <span className="text-xs text-white">{experience.rating}</span>
          <span className="text-[10px] text-gray-400">({experience.reviews})</span>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-400 mt-1 line-clamp-2">{experience.description}</p>
        ...
        <div className="flex items-center justify-between mt-4 pt-3 border-t border-white/5">
          <div>
            <p className="text-lg font-semibold text-white">₹{experience.price.toLocaleString()}</p>
