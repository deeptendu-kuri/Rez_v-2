...
const DealCard = ({ deal }) => (
  <div className={`min-w-[160px] p-4 rounded-2xl bg-gradient-to-br ${deal.color} shrink-0`}>
    ...
    <h4 className="font-semibold text-white mt-2">{deal.title}</h4>
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Event Rewards</h2>
          </div>
      ...
      <div className="px-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-semibold text-white">Special Perks</h2>
        </div>
