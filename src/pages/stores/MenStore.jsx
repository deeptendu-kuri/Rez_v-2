  ...
  return (
    <div className="min-h-screen bg-black pb-24">
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-white">Men Store</h1>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E]">
        <h3 className="font-semibold text-white mb-3">Why Shop Men's on ReZ?</h3>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">📦</span>
            <h4 className="text-sm font-medium text-white mt-1">Smart Bundles</h4>
            <p className="text-xs text-gray-400 mt-0.5">Curated combos</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">💰</span>
          ...
          <div className="p-3 rounded-xl bg-white/5">
            ...
            <h4 className="text-sm font-medium text-white mt-1">Book Services</h4>
            <p className="text-xs text-gray-400 mt-0.5">Barber & grooming</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">⚡</span>
            <h4 className="text-sm font-medium text-white mt-1">Fast Delivery</h4>
            <p className="text-xs text-gray-400 mt-0.5">60-min express</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 px-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-semibold text-white">Smart Bundles</h2>
        </div>
      ...
      <div className="mt-6 px-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-semibold text-white">Book Grooming Services</h2>
        </div>
        <div className="flex gap-3 overflow-x-auto hide-scrollbar pb-2">
          {menStore.barberServices.map((service) => (
            <div
              key={service.id}
              className="min-w-[160px] p-4 rounded-2xl bg-[#2C2C2E] shrink-0"
            >
              ...
              <button className="w-full mt-3 py-2 rounded-xl bg-blue-500 text-sm font-medium text-white">
                Book Now
              </button>
            </div>
          ))}
          ...
          {['Jack & Jones', 'Van Heusen', 'Bombay Shaving'].map((store, idx) => (
            <div key={idx} className="p-4 rounded-2xl bg-[#2C2C2E] flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">{1.5 + idx * 0.8} km away</p>
              </div>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-blue-500/10 border border-blue-500/20">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="font-semibold text-white">Men's Club Progress</h3>
            <p className="text-xs text-gray-400">2 more purchases to unlock bonus</p>
          </div>
        </div>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E] text-center">
        <h3 className="font-semibold text-white mb-2">Built for Men. Rewarding Every Time.</h3>
        <p className="text-sm text-gray-400">Quality products. Smart bundles. With ReZ rewards.</p>
      </div>
      ...
      <div className="fixed bottom-20 left-0 right-0 px-4 z-50">
        <div className="p-3 rounded-2xl bg-blue-600 shadow-xl flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-white">💪 Save ₹3,000 on bundles</p>
