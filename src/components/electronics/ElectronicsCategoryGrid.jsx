...
import { electronicsCategories } from '../../data/electronicsData';

const ElectronicsCategoryGrid = ({ onCategorySelect }) => {
  return (
    <div className="px-4">
      <h2 className="font-semibold text-rez-navy dark:text-white mb-3">Shop by Category</h2>
      <div className="grid grid-cols-4 gap-3">
        {electronicsCategories.map((category) => (
          <Link
            key={category.id}
            to={`/electronics/${category.id}`}
...
export default ElectronicsCategoryGrid;
