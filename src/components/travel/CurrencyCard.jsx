    ...
    <div className="min-w-[200px] p-4 rounded-2xl bg-white dark:bg-[#2C2C2E] shrink-0">
      ...
      <div className="flex items-center justify-center gap-3 mb-3">
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-rez-navy dark:text-white mt-1">{currency.from}</p>
        </div>
        <ArrowRight className="w-5 h-5 text-rez-gray-600 dark:text-gray-500" />
        <div className="text-center">
          <span className="text-3xl">{currency.toFlag}</span>
          <p className="text-sm font-medium text-rez-navy dark:text-white mt-1">{currency.to}</p>
        </div>
      </div>
      ...
      <div className="text-center mb-3">
        ...
        <p className="text-xs text-rez-gray-600 dark:text-gray-400">Live rate</p>
      </div>
