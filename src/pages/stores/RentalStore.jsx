    ...
    <div className="min-h-screen bg-black pb-24">
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-white">Rental Store</h1>
      ...
      <div className="mt-4 px-4">
        <div className="flex items-center justify-between mb-3">
          <h2 className="font-semibold text-white">Rent by Category</h2>
        ...
        <div className="grid grid-cols-2 gap-3">
          {rentalStore.categories.map((category) => (
            ...
            >
              ...
              <p className="text-xs text-gray-400 mt-1">{category.items} items</p>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E]">
        <h3 className="font-semibold text-white mb-3">Why Rent on ReZ?</h3>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">💰</span>
            <h4 className="text-sm font-medium text-white mt-1">Save Money</h4>
            <p className="text-xs text-gray-400 mt-0.5">Use, don't own</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">🪙</span>
            <h4 className="text-sm font-medium text-white mt-1">Earn Cashback</h4>
            <p className="text-xs text-gray-400 mt-0.5">Up to 20% back</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">🛡️</span>
            <h4 className="text-sm font-medium text-white mt-1">Protected</h4>
            <p className="text-xs text-gray-400 mt-0.5">Damage coverage</p>
          </div>
          <div className="p-3 rounded-xl bg-white/5">
            <span className="text-xl">⚡</span>
            <h4 className="text-sm font-medium text-white mt-1">Fast Delivery</h4>
            <p className="text-xs text-gray-400 mt-0.5">Same-day available</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 px-4">
        <div className="flex items-center justify-between mb-3">
          <h2 className="font-semibold text-white">Popular Rentals</h2>
          <button className="text-xs flex items-center gap-1" style={{ color: theme.primary }}>
            View All <ChevronRight className="w-3 h-3" />
          </button>
        </div>
          ...
          {rentalStore.rentals.map((rental) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <h3 className="font-medium text-white">{rental.name}</h3>
      ...
      <div className="mt-6 px-4">
        <div className="p-4 rounded-2xl" style={{ backgroundColor: `${theme.primary}15` }}>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-white">Earn Bonus Coins</h3>
          </div>
          <div className="space-y-2">
            {rentalStore.bonuses.map((bonus) => (
              <div key={bonus.id} className="flex items-center justify-between p-3 rounded-xl bg-white/10">
                <div>
                  <span className="text-sm text-white">{bonus.action}</span>
                  <p className="text-[10px] text-gray-400">{bonus.description}</p>
                </div>
      ...
      <div className="mt-6 px-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-semibold text-white">Add-ons</h2>
        </div>
        <div className="space-y-2">
          {rentalStore.addons.map((addon) => (
            <div key={addon.id} className="flex items-center justify-between p-3 rounded-xl bg-[#2C2C2E]">
              <div>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E]">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-semibold text-white">Book a Rental</h3>
        </div>
        <p className="text-sm text-gray-400 mb-4">Select dates and duration for your rental</p>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between px-4 mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-white">Rental Partners Nearby</h2>
          </div>
        </div>
          ...
          {['Rentomojo', 'Furlenco', 'RentSher'].map((store, idx) => (
            <div key={idx} className="p-4 rounded-2xl bg-[#2C2C2E] flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">{2 + idx} km away</p>
              </div>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl border" style={{ backgroundColor: `${theme.primary}10`, borderColor: `${theme.primary}30` }}>
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="font-semibold text-white">Smart Renter Progress</h3>
            <p className="text-xs text-gray-400">2 more rentals to unlock bonus</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-400">3/5 rentals</span>
      ...
      <div className="mx-4 mt-6 p-4 rounded-2xl bg-[#2C2C2E] text-center">
        <h3 className="font-semibold text-white mb-2">Use More. Own Less.</h3>
        <p className="text-sm text-gray-400">Smart savings through rentals. With ReZ rewards.</p>
      </div>
      ...
      <div className="fixed bottom-20 left-0 right-0 px-4 z-50">
        <div className="p-3 rounded-2xl shadow-xl flex items-center justify-between" style={{ backgroundColor: theme.primary }}>
          <div>
            <p className="text-sm font-medium text-white">🔄 Save ₹10,000+ by renting</p>
            <p className="text-xs text-white/70">Smart choice, smart savings</p>
          </div>
          <div className="flex gap-2">
            <Button variant="secondary" size="sm" className="bg-white/20 text-white border-0">Browse</Button>
